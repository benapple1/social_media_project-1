...
def friends(request):
    ...
    #to get eligble profiles, exclude the user, their exisiting friends, and friend request sent already
    ...
    #get friend request received by the user
    request_received_profiles = Relationship.objects.filter(receiver=user_profile, status='sent')

    #if this is the first time to access the friend requests page, creat eht eifrst relationshio 
